...
export default () => {return (
    <div className='IntroductionText'>
        <h2 className='IntroductionText__title'>Introduction</h2>
        <p className='IntroductionText__description'>No more barriers. No more stuck liquidity. No more chain wars. <br /> <br />
